...
namespace cipher_in_picture
{
    public partial class Form1 : Form
    {
        ...
        {
            int[] masbinary = new int[(textBox1.Text.Length + 1) * 16];
            ...
            for (int i = 0; i < textBox1.Text.Length * 16; i++)
            ...
            {
                Color pixelColor = MyImage.GetPixel(i%500, i / 500);
                byte r = pixelColor.R;
                byte g = pixelColor.G;
                byte b = pixelColor.B;
                ...
                MyImage2.SetPixel(i%500, i / 500, Color.FromArgb(r, g, b));
            }
            ...
            {
                Color pixelColor = MyImage.GetPixel(masbinary.Length / 3%500, masbinary.Length / 3 / 500);
                byte r = pixelColor.R;
                if ((r % 2 == 1) && (masbinary[countmasbinary] == 0))
                    r--;
                else
                ...
                MyImage2.SetPixel(masbinary.Length / 3%500, masbinary.Length / 3 / 500, Color.FromArgb(r, pixelColor.G, pixelColor.B));
            }
        ...
        {
            int[,] masbinary = new int[100000, 16];
            int x = 0, y = 0, i = 0, j = 0;
            while (true)
            {
                Color pixelColor = MyImage2.GetPixel(x, y);
                masbinary[i, j] = pixelColor.R % 2;
                j++;
                if (j > 15)
                {
                    j = 0;
                    if ((masbinary[i, 0] == masbinary[i, 1]) &( masbinary[i, 1] == masbinary[i, 2]) & (masbinary[i, 2] == masbinary[i, 3]) & (masbinary[i, 3] == masbinary[i, 4]) & (masbinary[i, 4] == masbinary[i, 5]) & (masbinary[i, 5] == masbinary[i, 6]) & (masbinary[i, 6] == masbinary[i, 7]) & (masbinary[i, 7] == masbinary[i, 8]) & (masbinary[i, 8] == masbinary[i, 9]) & (masbinary[i, 9] == masbinary[i, 10]) & (masbinary[i, 10] == masbinary[i, 11]) & (masbinary[i, 11] == masbinary[i, 12]) & (masbinary[i, 12] == masbinary[i, 13]) & (masbinary[i, 13] == masbinary[i, 14]) & (masbinary[i, 15] == masbinary[i, 15]) & (masbinary[i, 15] == 0))
                        break;
                    i++;
                }
            ...
            for (int counti = 0; counti < i; counti++)
                for (int countj = 0; countj < 16; countj++)
